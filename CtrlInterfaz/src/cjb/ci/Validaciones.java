...
public class Validaciones
{
    ...
    public static void enterConsume(JFrame jf, KeyEvent ke, Object obj)
    {
        if (ke.getKeyChar() == '\n')
        {
            ke.consume();
     ...
     * @param ke Variable evt del método KeyPress
     * @param obj Objeto al que se desea pasar al momento de dar enter
     * @param s Recibe la caja de texto actual
     */
    public static void enterCNV(JFrame jf, KeyEvent ke, JTextField s, Object obj)
    {
        if (ke.getKeyChar() == '\n')
        {
    ...
    /**
     * Metodo que valida si la longitud del texto de un arreglo de objetos es
     * menor a un numero dado con que uno sea menor manda un mensaje y devuelve
     * true
     *
     * @param size tamaño que se valida
     * @param jf frame donde se desea mandar el mensaje
     * @param s mensaje que se desea mostrar
     * @param obj arreglo de JTxareas o JTextFields que van a ser validados
     * @return si la longitud del texto de tan soloo un objeto es menor a size
     * manda true
     */
    public static boolean validaLongitud(int size, JFrame jf, String s, Object... obj)
    {
        boolean menor = false;
        for (Object x : obj)
        {
            ...
            {
                if (((JTextField) x).getText().length() < size)
                {
                    menor = true;
                    Mensajes.error(jf, s);
            ...
            } else
            {
                ...
                {
                    if (((JTextArea) x).getText().length() < size)
                    {
                        menor = true;
                        Mensajes.error(jf, s);
                        break;
